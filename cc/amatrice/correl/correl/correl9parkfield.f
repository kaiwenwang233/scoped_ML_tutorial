...
c --- Input parameters
	...
	t1=0.			! seconds before pick to read in
        t2=0.75         ! seconds after P-pick to read in, window is
        w1=0.5          ! P-window length of short window (seconds)
c        t2=1.0          ! seconds after S-pick to read in, window is
c        w1=0.75         ! S-window length of short window (seconds)
        delta=0.004             ! sample interval, resamples if
